...
module.exports = (grunt) ->
  ...
  grunt.initConfig
    ...
    watch:
      ...
      livereload:
        files: ["<%= yeoman.app %>/**/*.html", "{.tmp,<%= yeoman.app %>}/styles/{,*/}*.css", "{.tmp,<%= yeoman.app %>}/scripts/{,*/}*.js", "<%= yeoman.app %>/images/{,*/}*.{png,jpg,jpeg,webp}"]
        tasks: ["livereload"]
    ...
    #     "handlebars": "../../app/components/handlebars/handlebars",
    #     "underscore": "../../app/components/underscore/underscore-min",
    #     "backbone": "../../app/components/backbone/backbone-min",
    #     "localStorage": "../../app/components/backbone.localStorage/backbone.localStorage-min",
    #     "d3": "../../app/components/d3/d3.min"
    # }
    useminPrepare:
